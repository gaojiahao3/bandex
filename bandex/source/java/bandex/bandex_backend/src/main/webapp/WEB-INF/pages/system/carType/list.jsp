...
<div class="main administrator">
	...
	<div class="main-top">    
            <h3>车型管理列表 <small>共<span>${apiRsp.count}</span>个</small></h3>              
    </div><!--main-top-->
  ...
  <div class="panel-heading">
          ...
          <table class="table table-hover">
            ...
            <c:forEach items="${apiRsp.results}" var="item">
              ...
              <td><input type="checkbox" name="list-checkbox" value="${item.id}"></td>
                ...
                <span class="row-actions"><a href="javascript:editCarType('${item.id}');"><span class="glyphicon glyphicon-th-list"></span>编辑车型</a></span>
                </td>
                <td>${item.widthLength}</td>
    ...
    <div class="main-bottom">
		<jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
			...
			<jsp:param name="requestUrl" value="${ctx}/system/carType/list" />
...
function editCarType(id){
	openDialog({
	    ...
	    height:700,
	    width:700,
		url:"${ctx}/system/carType/edit?id="+id
	});	
}
