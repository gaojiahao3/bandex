...
import com.bandex.base.dto.ApiKeyDto;
import com.bandex.base.dto.ApiRequest;
import com.bandex.base.dto.ApiResponse;
import com.bandex.base.enums.ApiMsgEnum;
import com.bandex.base.utils.ApiSignUtil;
import com.bandex.base.utils.JsonUtil;
import com.bandex.base.utils.MemcachedUtil;
import com.bandex.base.web.SpringBeanProxy;
import com.bandex.base.web.SuperDispatcherServlet;
	...
	private ApiMsgEnum checkParam(ApiRequest apiReq) {
		...
		if (!StringUtils.isEmpty(apiReq.getUserToken())) {
			...
			if (sessionDto != null) {
				...
				apiReq.setCurrentUserDisplayName(sessionDto.getDisplayName());
